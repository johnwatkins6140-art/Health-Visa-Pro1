    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 py-8 md:py-10">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-sm text-gray-600 mb-8">Payment is processed securely by Paystack on behalf of His Majesty's Government. Your card details are encrypted and are not stored.</p>
            ...
            <div className="md:col-span-3">
              <div className="bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100" style={{ backgroundColor: ukBlue }}>
                  ...
                  <p className="text-xs text-blue-200 mt-0.5">Powered by Paystack</p>
                </div>
                <div className="p-5">
                  <div className="mb-6">
                  ...
                  <div className="border border-gray-100 rounded-sm p-4 mb-5 bg-gray-50">
                    <p className="text-xs text-gray-500 mb-2 font-semibold uppercase tracking-wide">You will be charged</p>
                    <p className="text-3xl font-bold" style={{ color: ukBlue }}>£{totalFee.toLocaleString()}</p>
                    <p className="text-xs text-gray-500 mt-1">Immigration visa application fee</p>
                  </div>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3.5 px-4 text-sm font-bold text-white rounded-sm transition-opacity hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2"
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        Pay £{totalFee.toLocaleString()} securely
                      </>
                    )}
                  </button>

                  {error && (
                    <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-sm text-xs text-red-700">
                      {error}
                    </div>
                  )}
                  ...
                  <p className="mt-4 text-center text-xs text-gray-400">
                    By paying you confirm your application is complete and correct.<br />
                    The visa fee is non-refundable once submitted.
                  </p>
                </div>
              </div>
      ...
      <main className="flex-1 py-10 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white border border-gray-200 shadow-sm rounded-sm overflow-hidden mb-6">
            <div className="h-2" style={{ backgroundColor: ukGreen }} />
            <div className="p-8 md:p-10">
              <div className="flex items-start gap-5 mb-8">
                <div className="w-14 h-14 rounded-full flex-shrink-0 flex items-center justify-center" style={{ backgroundColor: ukGreen }}>
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-1" style={{ color: ukBlue }}>Application submitted and payment received</h2>
                  <p className="text-sm text-gray-600 leading-relaxed">Your {isHealthCare ? "Health and Care Worker" : "Skilled Worker"} Visa application has been received and your payment has been processed successfully.</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-sm p-5 mb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div><p className="text-xs text-gray-500 mb-0.5">Payment reference</p><p className="font-mono font-semibold text-gray-800">WP-{refNumber.replace("SW-","")}</p></div>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ["Confirmation email", `A payment receipt and application confirmation will be sent to ${form.email} within 2 working hours. Quote reference ${refNumber} in all correspondence.`],
                  ["Biometric appointment", "You will be invited to attend your nearest Visa Application Centre (VAC) for fingerprint and photograph enrolment. You cannot travel to the UK until this is complete."],
                  ["Visa decision", wantsPriority === "super"
                    ? "Super Priority: decision expected by end of the next working day after your biometric appointment."
                    : wantsPriority === "priority"
                    ? "Priority service: decision expected within 5 working days of your biometric appointment."
                    : "Standard processing: decision expected within 3 weeks of your biometric appointment."],
                  ["Starting work", "Do not travel to the UK or start work until you have received your Biometric Residence Permit (BRP) and your visa has been granted."],
                ].map(([title, desc], i) => (
                  <div key={i} className="flex gap-3">
                    <div className="w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center text-white text-xs font-bold mt-0.5" style={{ backgroundColor: ukBlue }}>{i + 1}</div>
                    <div>
                      <p className="font-semibold text-gray-900 text-sm">{title as string}</p>
                      <p className="text-gray-600 text-xs leading-relaxed mt-0.5">{desc as string}</p>
                    </div>
                  </div>
                ))}
              </div>

              <div className="bg-amber-50 border border-amber-200 rounded-sm p-4 text-xs text-amber-900 mb-6">
                <strong>Important:</strong> Your CoS reference <strong>{form.cosReference || "—"}</strong> must match your visa application exactly. Discrepancies may delay or invalidate your application. Do not accept alternative employment before your visa is granted.
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button className="px-5 py-2.5 text-sm font-semibold text-white rounded-sm hover:opacity-90 transition-opacity flex items-center gap-2" style={{ backgroundColor: ukBlue }}>
